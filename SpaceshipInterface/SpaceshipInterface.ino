...
void loop() {
    // checks the status of the input pin 2, if it's LOW, the green light turns
    // on and reds turn off, if it's HIGH, the green lights turn on, red 1 turns
    // on, and red 2 flashes.
